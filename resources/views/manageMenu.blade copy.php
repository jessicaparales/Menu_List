                        ...
                        <form method="post" action = "/editMenu/{{ $manageMenu->menu_id }}" enctype="multipart/form-data">
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-12">
                              ...
                              <textarea class="form-control" name="editdescription" id="">{{ $manageMenu->menu_description }}</textarea>
                            </div>
                            <div class="col-12">
            ...
            <div class="modal-body">
              <form method="post" action="/addMenu" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <label for="price" class="form-label">Price</label>
                    <input type="text" name="menu_price" class="form-control" id="menu_price">
                  </div>
                  <div class="col-12">
